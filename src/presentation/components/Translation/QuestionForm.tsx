...
import { AppDispatch } from "@/infrastructure/state/store.ts"; // Importar el tipo AppDispatch
import { saveQuestionsAction } from "@/infrastructure/state/actions.ts"; // Importar la acción
