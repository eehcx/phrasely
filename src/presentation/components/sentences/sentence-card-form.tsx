...
import { useSentenceSelection } from "@/presentation/contexts/sentence-form-context.tsx";

import { Button, buttonVariants } from "@/presentation/components/ui/button.tsx";
import { Card, CardHeader, CardTitle, CardContent, CardFooter } from "@/presentation/components/ui/card.tsx";
import { Label } from "@/presentation/components/ui/label.tsx"
import { RadioGroup, RadioGroupItem } from "@/presentation/components/ui/radio-group.tsx"
import { ISenteceFormSchema } from "@/presentation/components/sentences/fields-sentences/types/ISentenceFormSchema.ts";
import { cn } from "@/infrastructure/utils/utils.ts";
