...
import { ExerciseSentenceCard } from "@/presentation/components/quizz/exercise-sentence-card.tsx";
import { IoArrowBackOutline, IoArrowForwardOutline, IoTrashOutline } from "react-icons/io5";
import { GrHomeRounded } from "react-icons/gr";
import { CustomButton } from "./control-button.tsx";
import { useAppDispatch, useAppSelector } from "@/infrastructure/state/reduxHooks.ts";
import { Question } from "@/core/types/questionType.ts";
import { Sentence } from "@/core/types/sentenceType.ts";
import { updateScore, nextGuest } from "@/infrastructure/state/slices/userSlice.ts";
