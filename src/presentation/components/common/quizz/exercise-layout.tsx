...
import { ExerciseSentenceCard } from "@/presentation/components/common/quizz/exercise-sentence-card.tsx";
...
import { updateScore, nextGuest } from "@/data/state/slices/userSlice.ts";
